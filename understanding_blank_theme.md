...
So if some of you already figured this one out, just leave a comment here or better [at my github](https://github.com/fragdochkarl/mage2docs/blob/master/understanding_blank_theme.md) ;)
